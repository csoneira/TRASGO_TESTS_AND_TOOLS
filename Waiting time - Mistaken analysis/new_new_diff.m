...
waiting_times = diff(event_times); % Convert to microseconds
...
% Plot waiting time histogram with counts normalized by bin width
subplot(1, 2, 1);
% bar(waiting_time_bins(1:end-1), waiting_counts, 'histc'); % Use 'histc' with normalized counts
