...
d_total_values = np.linspace(0.5, 10, 30)  # Total distances in meters
m_values = np.arange(4, 30, 1)  # Number of equidistant planes as integers
energies_values = np.logspace(np.log10(0.32e9), np.log10(10e9), 30)  # Energy in eV
sigma_T_values = np.linspace(0.010, 0.500, 30)  # Timing resolution values in ns
# --------------------------------------------------------------------------
