...
# Iterants
n = 15  # Change this value to select 1 out of every n values
...
# Save the final DataFrame that is being plotted
final_df = pd.DataFrame({
    'time_window_sizes': time_window_sizes,
    'mean_residuals_real': mean_residuals_real,
    'std_residuals_real': std_residuals_real,
    'mean_residuals_flux': mean_residuals_flux,
    'std_residuals_flux': std_residuals_flux
})

# Save to CSV
final_df.to_csv('final_residuals.csv', index=False)
